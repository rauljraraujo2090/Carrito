                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="registrar.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" name="dni"class="form-control" placeholder="Ingrese su Dni">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-password">Apellido-Nombres</label>
                                            <input type="text" id="example-password" name="apellidos-nombres"class="form-control"  placeholder="Ingrese su Apellidos-Nombres">
                                        </div>


                                        <div class="form-group">
                                            <label for="example-password">Correo</label>
                                            <input type="text" id="example-password" name="correos"class="form-control"  placeholder="Ingrese su Correo">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="Number" id="example-password" name="celular"class="form-control"  placeholder="Ingrese su Telefono">
                                        </div>
                                                
                                                
                                        <div class="form-group">
                                            <label for="example-password">Direccion</label>
                                            <input type="text" id="example-password" name="direc"class="form-control"  placeholder="Ingrese su Direccion">
                                        </div>
                                                

                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Fecha de Nacimiento</label>
                                            <input type="date" class="form-control" name="nacimiento"id="exampleFormControlInput1" placeholder="name@example.com">
                                        </div>
